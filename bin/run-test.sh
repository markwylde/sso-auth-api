...
docker run -p 9229:9229 --name featuretestrunner -it -v `pwd`:/app --link featuretestdb -e PORT=8011 -e DB_HOST=featuretestdb -e DB_NAME=featuretests msplat/auth-api:local $*
